...
export default class Car {
    ...
    setChassis() {
        ...
        // Matériau bleu pour la carrosserie
        ...
        // Appliquer le matériau bleu uniquement aux parties de la carrosserie
        this.chassis.object.traverse((child) => {
            if (child.isMesh && (child.name.toLowerCase().includes("body") || child.name.toLowerCase().includes("chassis"))) {
                child.material = blueMaterial;
                child.material.needsUpdate = true;  // Forcer la mise à jour du matériau
                console.log(`Changement de couleur pour : ${child.name}`); // Log pour vérifier les changements
            }
        });
