        ...
        this.list = [
            {
                ...
                link:
                {
                    href: 'https://ayabenaicha.github.io/index.html',
                    x: - 4.8,
                    y: - 3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://ayabenaicha.github.io/index5.html',
                    x: - 4.8,
                    y: - 3.3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://ayabenaicha.github.io/index6.html',
                    x: - 4.8,
                    y: - 2,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://ayabenaicha.github.io/index3.html',
                    x: - 4.8,
                    y: - 3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://ayabenaicha.github.io/index2.html',
                    x: - 4.8,
                    y: - 4,
                    halfExtents:
                    {
