...
export default class Floor
{
    constructor(_options)
    {
        ...
        // Colors (change the orange colors to pink shades)
        this.colors = {}
        this.colors.topLeft = '#ffccf9'   // Light pink
        this.colors.topRight = '#ff99cc'  // Medium pink
        this.colors.bottomRight = '#ff66b2'  // Bright pink
        this.colors.bottomLeft = '#ff80bf'  // Soft pink
